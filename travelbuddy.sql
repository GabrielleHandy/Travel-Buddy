...
ALTER TABLE ONLY public.travelplanners DROP CONSTRAINT travelplanners_user_id_fkey;
ALTER TABLE ONLY public.tps_dests DROP CONSTRAINT tps_dests_tp_id_fkey;
ALTER TABLE ONLY public.tps_dests DROP CONSTRAINT tps_dests_dest_id_fkey;
ALTER TABLE ONLY public.embassies DROP CONSTRAINT embassies_dest_id_fkey;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_pkey;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_email_key;
ALTER TABLE ONLY public.travelplanners DROP CONSTRAINT travelplanners_pkey;
ALTER TABLE ONLY public.tps_dests DROP CONSTRAINT tps_dests_pkey;
ALTER TABLE ONLY public.embassies DROP CONSTRAINT embassies_pkey;
ALTER TABLE ONLY public.destinations DROP CONSTRAINT destinations_pkey;
ALTER TABLE public.users ALTER COLUMN user_id DROP DEFAULT;
ALTER TABLE public.travelplanners ALTER COLUMN tp_id DROP DEFAULT;
ALTER TABLE public.tps_dests ALTER COLUMN tpdest_id DROP DEFAULT;
ALTER TABLE public.embassies ALTER COLUMN embassy_id DROP DEFAULT;
ALTER TABLE public.destinations ALTER COLUMN dest_id DROP DEFAULT;
DROP SEQUENCE public.users_user_id_seq;
DROP TABLE public.users;
DROP SEQUENCE public.travelplanners_tp_id_seq;
DROP TABLE public.travelplanners;
DROP SEQUENCE public.tps_dests_tpdest_id_seq;
DROP TABLE public.tps_dests;
DROP SEQUENCE public.embassies_embassy_id_seq;
DROP TABLE public.embassies;
...
--
-- Name: destinations_dest_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: destinations_dest_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: embassies; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: embassies_embassy_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: embassies_embassy_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: tps_dests; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: tps_dests_tpdest_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: tps_dests_tpdest_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: travelplanners; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: travelplanners_tp_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: travelplanners_tp_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: destinations dest_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: embassies embassy_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: tps_dests tpdest_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: travelplanners tp_id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Data for Name: embassies; Type: TABLE DATA; Schema: public; Owner: -
--
...
125	United States	26.2528989	127.7386313	U.S. Consulate General Naha 2-1-1 Toyama, Urasoe City, Okinawa	https://jp.usembassy.gov	311
122	United States	35.1728083	136.8901895	Nagoya International Center Bldg. 6F 1-47-1 Nagono, Nakamura-ku, Nagoya 450-0001	https://jp.usembassy.gov	309
124	United States	43.056348	141.313697	Kita 1-jo Nishi 28-chome, Chuo-ku Sapporo 064-0821, Japan	https://jp.usembassy.gov	310
126	United States	34.69680330000001	135.501877	2-11-5, Nishitenma Kita-ku, Osaka 530-8543	https://jp.usembassy.gov	312
118	United States	45.47500290000001	9.1944964	via Principe Amedeo, 2/10 20121 MILANO	https://it.usembassy.gov	307
120	United States	40.8321873	14.2260334	Piazza della Repubblica 80122 NAPOLI	https://it.usembassy.gov	308
100	United States	41.9060753	12.4913537	Via Sallustiana, 49 00187 Rome, Italy	https://it.usembassy.gov	298
119	United States	41.9072651	12.4905066	via Vittorio Veneto 121 00187 Roma	https://it.usembassy.gov	109
...
127	United States	33.5881047	130.3730286	5-26 Ohori 2-chome Chuo-ku Fukuoka 810-0052	https://jp.usembassy.gov	313
123	United States	35.6688048	139.743326	1-10-5 Akasaka Minato-ku, Tokyo 107-8420 JAPAN	https://jp.usembassy.gov	112
117	United States	43.7738567	11.240557	Lungarno Vespucci, 38 50123 Firenze	https://it.usembassy.gov	306
\.


--
-- Data for Name: tps_dests; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: travelplanners; Type: TABLE DATA; Schema: public; Owner: -
--
...
12	Johnny	Bravo	jbravo.com	test	United States
13	Johnny	Test	jtest@test.com	test	United States
\.


--
-- Name: destinations_dest_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.destinations_dest_id_seq', 515, true);


--
-- Name: embassies_embassy_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: tps_dests_tpdest_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.tps_dests_tpdest_id_seq', 87, true);


--
-- Name: travelplanners_tp_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.travelplanners_tp_id_seq', 63, true);
...
--
-- Name: embassies embassies_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tps_dests tps_dests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: travelplanners travelplanners_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: embassies embassies_dest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tps_dests tps_dests_dest_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tps_dests tps_dests_tp_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: travelplanners travelplanners_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
